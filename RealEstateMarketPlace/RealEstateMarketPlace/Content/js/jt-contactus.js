    ...
    $("#btnContactUs").click(function () {
        ...
        $form.validate({
            ...
            messages: {
                ...
                txtSubject: "Please state the subject of your inquiry.",
                txtContact: "Contact no. is required.",
                txtName: "Please state your full name.",
                inquiryMessage: "Please state your inquiry.",
                txtEmailContactus: "Please specify a valid email address",
            },
...
function contactUs() {
    ...
    var _txtEmail = $("#txtEmailContactus").val();
    var _txtSubject = $("#txtSubject").val();
    var _inquiryMessage = $("#inquiryMessage").val();
