...
function toursPackage() {
    var key = 4;
    var postData = {
        packageCategoryKey: key
    }
    $.ajax({
        url: GetPackageListByCategory,
        type: "POST",
        dataType: "json",
            ...
            if (response.Result === 0) {
                ...
                for (i = 0; i < dataArray.length; i++) {
                    ...
                    opt += '<div class="col-md-3 pt-2 pb-2">'
                        + '<a href=' + window.baseUrl + 'Package/PackageDetails?key=' + dataArray[i].Key + ' id="zup">'
                        + '<div class="hover-class" id="' + dataArray[i].Key + '">'
                        + '<div class="row">'
                        + '<div class="col-md-12">'
                ...
                //$(".hover-class").click(function () {
                //    var id = $(this).attr("id");
                //    window.location = window.baseUrl + 'Package/PackageDetails?key=' + id;
                //});
            ...
            if (response.Result === 0) {
                ...
                for (i = 0; i < dataArray.length; i++) {
                    ...
                    opt += '<div class="col-md-3 pt-2 pb-2">'
                        ...
                        + '<div class="row">'
                        + '<div class="col-md-12 card-text-package-title">'
                        + '<span class="sub-title-orange text-uppercase"><i class="fa fa-heart package-heart" id="' + dataArray[i].Key + '"></i>' + dataArray[i].PackageCategoryName + '</span>'
                        + '</div>'
                        + '</div>'
                        + '<div class="row">'
                        + '<div class="col-md-12" style="height:56px;">'
